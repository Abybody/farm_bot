...
def sql_start():
    ...
    base.execute('CREATE TABLE IF NOT EXISTS users(user_id INTEGER PRIMARY KEY NOT NULL, link TEXT INTEGER, ref_manager TEXT INTEGER, referals INTEGER, name TEXT)')
    base.commit()
